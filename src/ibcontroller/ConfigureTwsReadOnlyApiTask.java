...
public class ConfigureTwsReadOnlyApiTask implements ConfigurationAction {

	final boolean mReadOnlyApi;
	private JDialog configDialog;

	ConfigureTwsReadOnlyApiTask(boolean readOnlyApi) { mReadOnlyApi = readOnlyApi; }
	...
	private void configure(final JDialog configDialog, final boolean readOnlyApi) {
		try {
